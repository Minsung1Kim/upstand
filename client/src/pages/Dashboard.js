  ...
  const sprintProgressData = {
    ...
    datasets: [{
      data: dashboardData?.active_sprint ? [
        dashboardData.active_sprint.completed_tasks || 30,
        dashboardData.active_sprint.total_tasks - (dashboardData.active_sprint.completed_tasks || 30) || 70
      ] : [0, 100],
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-500 mt-2">Team: {currentTeam?.name}</p>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  {dashboardData.active_sprint.completed_tasks || 30} of {dashboardData.active_sprint.total_tasks || 100} tasks completed
                </p>
              </div>
            </div>
          ) : (
